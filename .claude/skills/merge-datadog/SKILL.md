...
The scripts bellow should be executed as is, as executable, without passing it to the bash.  `.claude/skills/merge-datadog/find-previous-versions.sh` instead of `bash .claude/skills/merge-datadog/find-previous-versions.sh`
