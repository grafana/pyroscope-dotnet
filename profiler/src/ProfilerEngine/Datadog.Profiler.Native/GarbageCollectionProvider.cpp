...
GarbageCollectionProvider::GarbageCollectionProvider(
    ...
    :
    CollectorBase<RawGarbageCollectionSample>("GarbageCollectorProvider", valueTypeProvider.GetOrRegister(valueTypeProvider.GarbageCollectionDefinitions), rawSampleTransformer, memoryResource)
{
