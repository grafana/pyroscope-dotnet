...
public:
    ...
    // Id of the logical async scope chain (see AsyncScopeStore) the sampled code belongs to.
    // RawSampleTransformer turns it into the frames that sit above the physical stack.
