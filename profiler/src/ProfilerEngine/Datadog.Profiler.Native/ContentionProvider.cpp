...
ContentionProvider::ContentionProvider(
    ...
    :
    CollectorBase<RawContentionSample>("ContentionProvider", valueTypeProvider.GetOrRegister(valueTypeProvider.ContentionDefinitions), rawSampleTransformer, memoryResource),
