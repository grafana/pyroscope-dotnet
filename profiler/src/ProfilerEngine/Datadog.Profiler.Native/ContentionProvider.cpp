...
ContentionProvider::ContentionProvider(
    ...
    :
    CollectorBase<RawContentionSample>("ContentionProvider", valueTypeProvider.GetOrRegister2(valueTypeProvider.ContentionDefinitions), rawSampleTransformer, memoryResource),
