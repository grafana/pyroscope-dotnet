...
void EventPipeEventsManager::SetAllocationTrackingEnabled(bool enabled)
{
    _clrParser->SetAllocationTrackingEnabled(enabled);
}

void EventPipeEventsManager::SetContentionTrackingEnabled(bool enabled)
{
    _clrParser->SetContentionTrackingEnabled(enabled);
}
