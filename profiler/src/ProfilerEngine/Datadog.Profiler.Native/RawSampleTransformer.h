...
public:
    ...
    std::shared_ptr<Sample> Transform(const RawSample& rawSample, ProfileType profileType);

    void Transform(const RawSample& rawSample, std::shared_ptr<Sample>& sample, ProfileType profileType);
