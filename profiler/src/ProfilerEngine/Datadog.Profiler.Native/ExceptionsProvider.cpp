...
ExceptionsProvider::ExceptionsProvider(
    ...
    :
    CollectorBase<RawExceptionSample>("ExceptionsProvider", valueTypeProvider.GetOrRegister(valueTypeProvider.ExceptionDefinitions), rawSampleTransformer, memoryResource),
