...
public:
    RawSampleCollectorBase(
        ...
        SampleProfileType profileType,
        RawSampleTransformer* rawSampleTransformer,
        RingBuffer* ringBuffer,
        MetricsRegistry& metricsRegistry) :
        ProviderBase(name),
        _sampleTypes{std::move(sampleTypes)},
    ...
    {
        return std::make_unique<SamplesEnumeratorImpl>(std::move(_collectedSamples->GetReader()), _rawSampleTransformer, _sampleTypes, _profileType);
    }
...
private:
    ...
    public:
        ...
        bool MoveNext(std::shared_ptr<Sample>& sample) override
        {
            ...
            _rawSampleTransformer->Transform(*rawSample, sample, _sampleTypes, _profileType);
