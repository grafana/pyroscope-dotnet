...
{
    // This is the shape of every sample when PYROSCOPE_ASYNC_STITCHING_ENABLED=false:
    // the profiler reports physical stacks exactly as it did before stitching existed.
